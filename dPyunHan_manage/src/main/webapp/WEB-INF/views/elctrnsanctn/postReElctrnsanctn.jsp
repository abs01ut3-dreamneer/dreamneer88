						...
						document.addEventListener("DOMContentLoaded", function () {
							...
							async function getDrftDocFormat(drftDocId) {
								...
								try {
									...
									document.querySelector("#drftSj").value = '';
									...
									if (CKEDITOR.instances.drftCn) {
										...
										if (textarea) {
											...
											console.error("drftCn textarea를 찾을 수 없습니다.");
										}
									}
									modal.hide();
								} catch (error) {
								...
								Swal.fire({
									...
									if (result.isConfirmed) {
										Swal.fire({
											...
											submitForm("/elctrnsanctn/postReElctrnsanctn");
										});
									}
								});
							});
								...
								<div class="card-body">
									<div class="card card-info">
										<div class="card-header">
											...
											<input type="hidden" id="drftDocId" name="drftDocId"
												value="${elctrnsanctnVO.drftDocId}" /> <input type="hidden"
												id="elctrnsanctnManageId" name="elctrnsanctnManageId"
												value="${elctrnsanctnVO.elctrnsanctnManageId}" />
										</div>
										...
										<div class="card-body">
											<table class="table table-bordered table-sm">
												<tbody>
													<tr>
														...
														<td colspan="3">
															<input type="text"
																...
																id="drftSj" name="drftSj"
																value="${elctrnsanctnVO.drftSj}">
															<input type="hidden"
																value="${elctrnsanctnVO.elctrnsanctnSn}"
																id="upperElctrnsanctnId" name="upperElctrnsanctnId" />
														</td>
													</tr>
															...
															<table
																...
																<tbody id="sanctnTableBody">
																	<c:forEach var="sanctnlnVO"
																		...
																		<tr class="text-center sanctnlnEmp"
																			data-emp="${sanctnlnVO.empVO.empId}"
																			data-order="${sanctnlnVO.sanctnOrdr}">
																	...
																	<tr>
																		...
																		<td id="referenceTableFoot" colspan="5">
																			<c:forEach var="drftRefrnVO"
																				...
																				<span
																					class="badge badge-lg badge-light p-2 mr-2 drftRefrnEmp"
																					data-emp="${drftRefrnVO.empVO.empId}"
																					style="font-size: 0.9rem;">
																					${drftRefrnVO.empVO.nm}
																					${drftRefrnVO.empVO.clsfName}
																					<a class="badge badge-danger badge-sm ml-1 reference-delete-btn"
																						style="font-weight: bold; cursor: pointer;">X</a>
																				</span>
																			</c:forEach>
													...
													<tr>
														<th class="text-center align-middle col-2 bg-light">이전파일</th>
													...
													<tr>
														<th class="text-center align-middle col-2 bg-light">
															첨부파일</th>
													...
													<tbody>
														<c:forEach var="drftDocVO" items="${drftDocVOList}"
															...
															<tr class="drftDocVORow">
																<td>${status.count}<input type="hidden" id="drftDocId"
																		name="drftDocId" value="${drftDocVO.drftDocId}">
																</td>
