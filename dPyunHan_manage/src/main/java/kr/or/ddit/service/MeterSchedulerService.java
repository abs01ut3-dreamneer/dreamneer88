...
public class MeterSchedulerService {
    ...
    private static final LocalDateTime START_DATETIME = LocalDateTime.of(2025, 11, 20, 0, 0);
    private static final LocalDateTime END_DATETIME = LocalDateTime.of(2025, 11, 21, 23, 59);
