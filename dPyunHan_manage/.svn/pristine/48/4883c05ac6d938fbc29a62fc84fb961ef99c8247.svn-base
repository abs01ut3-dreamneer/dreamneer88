											...
											<table class="table table-bordered table-sm">
												<tbody>
													<tr>
														...
														<td colspan="3">${bdderVO.bidPblancVO.bidPblancSnAsStr}
															<input type="hidden" class="putBdderVO"
																value="${bdderVO.bidPblancVO.bidPblancSn}"
																name="bidPblancSn" />
														</td>
													</tr>
													<tr>
													...
													<tr>
														...
														<td>
															<fmt:formatDate value="${bdderVO.bidPblancVO.pblancDt}"
																pattern="yyyy-MM-dd" />
														</td>
													...
													<tr>
														...
														<td>
															<c:if test="${empty bdderVO.bidPblancVO.sptdcDtAsDate}">
																해당없음
															</c:if>
														</td>
														<th class="bg-light col-2 text-center">현장설명장소</th>
														<td>
															<c:if test="${empty bdderVO.bidPblancVO.sptdcPlace}">
																해당없음
															</c:if>
														</td>
													</tr>
													...
													<tr>
														<th class="bg-light col-2 text-center align-middle">첨부파일
														</th>
														<td colspan="3">
															<c:choose>
													...
													<tbody>
														...
														<tr>
															<th rowspan="2" class="bg-light text-center align-middle">
																입찰가액
																<input type="hidden" class="putBdderVO" name="bdderSn"
																	value="${bdderVO.bdderSn}">
															</th>
															<td colspan="3" class="table-warning">
																<span id="bidAmount"
																	data-bidAmount="${bdderVO.bidAmount }">
														...
														<tr>
															<td colspan="3"
																style="font-size: 0.8rem; color: lightslategray;">
														...
														<tr>
															...
															<td colspan="3" class="table-warning">
																<span id="bidGtn" data-bidGtn="${bdderVO.bidGtn }">
											...
											<table class="table table-bordered table-sm">
												<tbody>
													<tr>
														...
														<td>${bdderVO.ccpyManageVO.ccpyCmpnyNm}
															<input type="hidden" class="putBdderVO" name="ccpyManageId"
