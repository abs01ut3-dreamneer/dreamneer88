...
<script>
            ...
            function addIem() {
              ...
              str.innerHTML = `
                ...
                <input class="form-control" type="text"   name="voteIemVOList[\${idx}].iemNm"  placeholder="항목명">
			...
			<div class="card-body">
				...
				<div class="form-group">
					<table style="border-collapse: collapse; border: none; width: 100%;">
						<tr>
							<th style="border: none; text-align: left;">투표 시작</th>
							<td style="border: none;"><input class="form-control" required
								type="datetime-local" name="voteBeginDt"></td>
						</tr>
						<tr>
							<th style="border: none; text-align: left;">투표 마감</th>
							<td style="border: none;"><input class="form-control" required
