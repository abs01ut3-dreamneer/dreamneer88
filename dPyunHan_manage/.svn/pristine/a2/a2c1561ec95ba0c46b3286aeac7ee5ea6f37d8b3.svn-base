...
<textarea class="form-control special-note-box" rows="3" style="width: 100%; height: 200px; color: red;" readonly>
...
특이사항 발생 시 꼭 방문해서 도와주시기 바랍니다.</c:if>
			...
			<div class="card-footer text-right">
				...
				<c:forEach var="vo" items="${hshldDetailVO}">
				    <a href="/mtinsp/mtinspView?hshldId=${vo.hshldId}" class="btn btn-sm btn-success">검침 보기</a>
				</c:forEach>
			</div>
		</div>
	</c:if>
