        ...
        html += 
            ...
            '">' +
                ...
                '<div style="background: linear-gradient(135deg, #648ca4 0%, #5a7d94 100%); padding: 0.8rem; color: white; text-align: center;">' +
                    '<h3 style="font-size: 0.95rem; font-weight: 700; margin: 0; line-height: 1.3; color: white;">' + bbsGroup.bbsNm + '</h3>' +
                '</div>' +
                // 본문
                '<div style="padding: 0.6rem;">' +
                    ...
                    '<div style="display: flex; justify-content: space-between; margin-bottom: 0.5rem; padding-bottom: 0.5rem; border-bottom: 1px solid #e9ecef;">' +
                        '<div style="display: flex; align-items: center; gap: 0.3rem; font-size: 0.75rem;">' +
                            ...
                            '<span style="color: ' + (bbsGroup.answerAt == 1 ? '#28a745' : '#dc3545') + '; font-weight: 600;">' +
                                (bbsGroup.answerAt == 1 ? '가능' : '불가') +
                            '</span>' +
                        '</div>' +
                        '<div style="display: flex; align-items: center; gap: 0.3rem; font-size: 0.75rem;">' +
                            '<i class="fas fa-paperclip" style="color: #648ca4; font-size: 0.8rem;"></i>' +
                            '<span style="color: #6c757d; font-weight: 500;">파일:</span>' +
                            '<span style="color: ' + (bbsGroup.atchFileAt == 1 ? '#28a745' : '#dc3545') + '; font-weight: 600;">' +
                                (bbsGroup.atchFileAt == 1 ? '가능' : '불가') +
                            '</span>' +
                        '</div>' +
                    '</div>' +
                    // 통계
                    '<div style="display: flex; justify-content: space-around; padding-top: 0.3rem;">' +
                        '<div style="text-align: center;">' +
                            '<span style="display: block; font-size: 1rem; font-weight: 700; color: #648ca4; margin-bottom: 0.1rem;">0</span>' +
                ...
                '<div style="padding: 0.5rem 0.6rem; background: #f8f9fa; display: flex; justify-content: space-between; align-items: center;">' +
                    '<span style="font-size: 0.7rem; color: #6c757d;">#' + bbsGroup.bbsGroupSn + '</span>' +
                    '<div style="display: flex; gap: 0.3rem;">' +
                        // 수정 버튼
                        '<button onclick="event.stopPropagation(); openEditModal(' + bbsGroup.bbsGroupSn + ')" style="' +
                            'background: #ffc107; ' +
                            'color: white; ' +
                            'border: none; ' +
                        ...
                        // 삭제 버튼
                        '<button onclick="event.stopPropagation(); deleteBbsGroup(' + bbsGroup.bbsGroupSn + ')" style="' +
                            'background: #dc3545; ' +
                            'color: white; ' +
                            'border: none; ' +
                            'padding: 0.25rem 0.5rem; ' +
                        ...
                        // 보기 버튼
                        '<button onclick="event.stopPropagation(); goToBoardPage(' + bbsGroup.bbsGroupSn + ')" style="' +
                            'background: #648ca4; ' +
                            'color: white; ' +
                            'border: none; ' +
                            'padding: 0.25rem 0.5rem; ' +
