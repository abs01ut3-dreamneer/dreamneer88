...
.chatcontrols button {
  ...
  cursor: pointer;
  display: flex;                    /* ← 수평 센터 */
  justify-content: center;          /* ← 수평 센터 */
  align-items: center;              /* ← 수직 센터 */
...
<script>
  ...
  const ws = new WebSocket("ws://192.168.141.77:8272/ws/chat");
...
window.addEventListener("message", (e) => {
    ...
    if (e.data.action === "viewport") {
        ...
        const chatH = vh - headerH - inputH;

        chatArea.style.height = chatH + "px";
        chatArea.style.maxHeight = chatH + "px";
